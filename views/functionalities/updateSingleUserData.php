...
<body>
    ...
    <main>
        <div class="container my-5 px-3">
            <form action="../../controllers/functionalities/updateSingleUserData.php?account=<?php echo $data['id'] ?>" method="post">
                <div class="container py-2">
                    <h3>Modifier ses données</h3>
                </div>
                <div class="container py-2">
                    <input type="text" class="form-control" name="username" id="username" placeholder="Pseudo" value="<?php echo $data['username'] ?>" required />
                </div>
                <div class="container py-2">
                    <input type="text" class="form-control" name="email" id="email" placeholder="E-mail" value="<?php echo $data['email'] ?>" required />
                </div>
                <div class="container py-2">
